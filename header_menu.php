<nav class="navbar fixed-top navbar-expand-sm navbar-dark" style="background-color:rgba(0,0,0,0.5)">
            <div class="container">
                    <a href="index.php" class="navbar-brand" style="font-family: 'Delius Swash Caps'">iHERB</a>
                       ...
                       <li class="nav-item dropdown">
                           <a href="" class="nav-link dropdown-toggle" id="navbar-drop" data-toggle="dropdown">
                               ...
                               <div class="dropdown-menu">
                                   <a href="products.php#Life Extension" class="dropdown-item">Life Extension</a>
                                   <a href="products2.php#MuscleTech" class="dropdown-item">MuscleTech</a>
                                   <a href="products3.php#Nature's Way" class="dropdown-item">Nature's Way</a>
                                   <a href="products4.php#Enzymedica" class="dropdown-item">Enzymedica</a>
                               </div>
                           
                       </li>
                      
                       <li class="nav-item"><a href="about.php" class="nav-link">About Us</a></li>
                       <li class="nav-item"><a href="brandinfo.php" class="nav-link">Brand Information</a></li>
                       <?php
